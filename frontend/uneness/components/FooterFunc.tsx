...
import instagram from '../src/assets/icons/icons8-instagram.s
...
const Footer: React.FC = (): React.ReactNode | null => {
    const brandText: string = 'The journey to holistic wellness through mind, body, and soul harmony. Discover the path to your best self.';
    ...
    <footer>
        <div className={'footer-content-row'}>
            <div className='brand-col-gap'>
                ...
                <p className={'brand-col-gap-text'}>{brandText}</p>
            </div>
