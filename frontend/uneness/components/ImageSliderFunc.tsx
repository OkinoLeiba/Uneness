 ...
 *
 * @property {boolean} on - Indicates whether the slider is in the on/right position.
 */
...
const ImageSlider: React.FC<Props> = (props): React.ReactNode | null => {
    ...
    */
    ...
    return (
        <div style={trackStyle} onClick={toggle}>
            <div style={knobStyle}>
                <img
                    src={on ? srcRight : srcLeft}
                    alt={on ? altRight : altLeft}
                    style={imageStyle}
                />
            </div>
